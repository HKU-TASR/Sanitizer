...
# python extract_subnet_mov3_tiny.py
if __name__ == '__main__':
    now = datetime.now()
    now_str = now.strftime("%Y-%m-%d_%H-%M-%S")
    net1 = MobileNetV3_Small(num_classes=200)
    net2 = MobileNetV3_Small(num_classes=200)
    ...
    summary(subnet.cpu(), input_size=(3, 64, 64), device='cpu')
    print_summary(torch.randn(1, 3, 64, 64), subnet.cpu())
    ...
    print("save subnet_Tiny_SubMoblieNetV3 model")
    save_model(subnet, 'subnet_Tiny_MoblieNetV3_Real_' + now_str + '_.pt')