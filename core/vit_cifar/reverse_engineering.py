...
from extracted_vit_net_pure_attr import SubViT
...
# python reverse_engineering.py --gpu 0 --reverse_eps 30 --model_path ./vit_extracted_structures/lr_0.01/epochs_20/ViT_Cifar10_Real_Subnet_0.22025-01-22_03-49-27.pt
if __name__ == '__main__':
    ...
    out_pics_dir = os.path.join('./pics_', now_str + str(args.model_path).split('/')[-1])
