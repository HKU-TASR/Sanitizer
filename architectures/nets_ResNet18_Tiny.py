...
class ResNet(nn.Module):
    ...
    def forward(self, x):
        ...
        # 针对Tiny，因为最后的宽和高是[-1, 512, 8, 8]，所以这里直接写8；kernel_size 参数在调用 F.avg_pool2d 时是必需的，没有默认值
...
if __name__ == '__main__':
    ...
    net = ResNet18TinyImagenet()
    summary(net.cpu(), input_size=(3, 64, 64), device='cpu')
    print_summary(torch.randn(1, 3, 64, 64), net.cpu())
